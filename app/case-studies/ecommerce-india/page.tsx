      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-gray-300 leading-relaxed">
            ...
            ran a major sale event. Their fixed VM infrastructure could not handle traffic spikes, deployments
      ...
      <section className="py-10 bg-[#050B1A] border-y border-gray-800">
        <div className="max-w-4xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            { stat: '10×', label: 'Peak Traffic Handled' },
            { stat: '53%', label: 'Faster Page Load Times' },
            { stat: '38%', label: 'Cloud Cost Reduction' },
          ].map(({ stat, label }) => (
            <div key={label}>
      ...
      <section className="py-20 max-w-4xl mx-auto px-6 space-y-20">
        ...
        <div>
          ...
          <div className="bg-[#080f1e] border border-gray-800 rounded-2xl p-7 space-y-4 text-gray-300 leading-relaxed">
            ...
            <p>Deployments were equally fragile. There was no staging environment — all code changes were pushed directly to production, often late at night to avoid peak hours. New features were frequently released with bugs that impacted customers before engineers could respond. The team had started freezing deployments in the weeks before sale events entirely — which meant features and fixes were bottlenecked for weeks at a time.</p>
            <p>With their annual sale 10 weeks away, they came to us with a clear mandate: make the platform scale, or the next sale event will be the last one on their current infrastructure.</p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="rounded-2xl overflow-hidden border border-gray-800">
            ...
            {[
              { area: 'Scaling', before: 'Fixed VMs, manual resize before events', after: 'Auto-scaling ECS, responds within 60 seconds' },
              { area: 'Peak Traffic', before: 'Site down at 3× normal load', after: '10× load handled with zero downtime' },
              { area: 'Page Speed', before: 'Slow — no CDN, all served from origin', after: '53% faster — CloudFront + Redis caching' },
              { area: 'Deployments', before: 'Manual, direct to production, nights only', after: 'Automated CI/CD with staging gate' },
              { area: 'Database', before: 'Single RDS, connection exhaustion at peak', after: 'Multi-AZ RDS + read replica + PgBouncer' },
              { area: 'Cloud Costs', before: 'Oversized fixed VMs running 24/7', after: '38% lower — right-sized + auto-scaling' },
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              { category: 'Monitoring & Load Testing', tools: 'Grafana, Prometheus, CloudWatch, k6 load testing' },
              { category: 'Database', tools: 'Amazon RDS PostgreSQL Multi-AZ, read replica, PgBouncer' },
            ].map(({ category, tools }) => (
            ...
            {[
              {
                ...
                reason: 'With 10 weeks to the sale event, we could not spend 4 weeks setting up and learning EKS. ECS Fargate delivered the auto-scaling capability they needed in a fraction of the time, with significantly less operational complexity for a team their size.',
              },
              {
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              { week: 'Week 5', title: 'CDN & Caching', desc: 'CloudFront distribution configured. Redis cluster deployed. Caching strategy implemented and tuned per page type. Page loads 53% faster.' },
              { week: 'Week 6–7', title: 'CI/CD & Staging', desc: 'GitHub Actions pipeline built. Staging environment created. Blue/green deployment strategy implemented and tested.' },
              ...
              { week: 'Week 10', title: 'Sale Day & Handover', desc: 'Sale event executed flawlessly — zero downtime, 10× traffic handled. Post-event review and full documentation delivered.' },
            ].map(({ week, title, desc }) => (
        ...
        <div className="bg-[#080f1e] border border-gray-700 rounded-2xl p-8">
          <p className="text-gray-300 text-lg leading-relaxed italic mb-6">
            ...
            we were watching dashboards and celebrating instead of firefighting. The load tests ESSEMVEE
            ran found two bugs that would have taken us down. Worth every rupee."
          </p>
          <div className="border-t border-gray-700 pt-4">
            <p className="font-semibold text-white">Head of Technology</p>
            <p className="text-gray-500 text-sm">D2C eCommerce Platform · South Asia · </p>
          </div>
        </div>
