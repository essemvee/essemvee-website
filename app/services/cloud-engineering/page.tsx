    ...
    <main className="py-24 bg-black text-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <motion.div {...fadeInUp}>
            <h2 className="text-3xl font-bold mb-8">Global Advantages</h2>
            <ul className="space-y-4 text-lg text-gray-300">
        ...
        <motion.div {...fadeInUp} className="text-center mt-24">
          <Link href="https://clockhash.com/your-solution-partner/meeting" target="_blank" className="bg-blue-600 text-white px-16 py-8 rounded-full text-2xl font-bold hover:bg-blue-700 hover:scale-105 transition shadow-2xl">
